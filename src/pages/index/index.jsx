...
function Index() {
  ...
  useMediaQuery(1024) ? console.log('true') : console.log('false');
          ...
          <div className='place-items-center lb:w-1/2 justify-center items-center'>
            ...
            <div className='flex flex-col items-center justify-center'>
              <p className='p-6 lb:px-20 text-lg mb:text-xl text-justify max-w-[690px]'>
                ...
                tintas. Con décadas de experiencia, Epson se ha destacado por ofrecer soluciones de
                impresión de alta calidad para hogares y empresas.
              </p>
