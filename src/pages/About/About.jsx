    ...
    <div className='bg-gray-100 relative'>
      ...
      <div className='flex m-10 max-w-[100%] justify-center items-center'>
        <div className='flex justify-center max-w-[80%] flex-col'>
          ...
          <br />
          <p>
            En Rojo Digitalización e Impresión, nuestra misión principal es superar las expectativas
            de nuestros clientes. Nuestra trayectoria y experiencia en el sector nos respaldan, pero
            es nuestra pasión por ofrecer un servicio excepcional lo que nos diferencia. Cada
            interacción con nuestro equipo es una oportunidad para demostrar nuestro compromiso con
            la calidad y la excelencia. Desde asesoramiento personalizado hasta soluciones técnicas
            rápidas y efectivas, estamos aquí para garantizar que su experiencia con nosotros sea
      ...
      <div className='bg-gray-200 flex flex-wrap justify-evenly px-6 items-center'>
        <div className='flex flex-col items-center w-1/4 h-[272px] bg-white p-6 m-6 rounded-lg shadow-md cursor-pointer hover:shadow-lg transform hover:-translate-y-2 transition-transform'>
          ...
          <h3 className='text-xl font-semibold mt-2'>El cliente en el Centro</h3>
