...
const ItemDetail = () => {
  ...
  const [item, setItem] = useState(() => {
    if (location.pathname.includes("ricoh")) {
      return ricohProducts.filter(
        (product) => product.specs.modelCode === modelCode
      );
    } else if (location.pathname.includes("epson")) {
      return epsonProducts.filter(
        (product) => product.specs.modelCode === modelCode
      );
    }
  });
                ...
                <Accordion.Body>
                  ...
                  <div className="py-4">
                    ...
                    <li>
                      ...
                      {item[0].specs.general.size}
                    </li>
                    <li>
                      <span className="font-semibold">Peso:</span>{" "}
                      {item[0].specs.general.weight}
                    </li>
                    <li>
                      <span className="font-semibold">Origen:</span>{" "}
                      {item[0].specs.general.origin}
                    </li>
                  </div>
