export const products = [
...

    {
        ...
        description: [  'Extienda la productividad de impresión con un presupuesto limitado',
        ...
        general: {
            oz: 'Windows® 8.1, Windows® 10, Windows® Server 2012, Windows® Server 2012R2, Windows® Server 2016, Macintosh OS X v10.10 o posterior. Entorno Linux',
        ...
        paperHandling: {
            ...
            paperType: 'Delgado, Regular, Grueso, Reciclado, De Color, Especial, Con Membrete, Preimpreso, Bond*, Cartulina* Etiquetas*, Sobres** Estándar',
            paperWeight: '52 - 162 g/m²',
            paperEntryCapacity: 'Bandeja de 250 hojas + Bypass de 50 hojas (recomendada). 550 hojas max.',
...

    {
        ...
        description: [  'Mantener la productividad y el presupuesto',
                        'Producción de hasta 34 ppm, impresión',
                        'Resolución de impresión máx. 1200 x 1200 ppp',
                        'Capacidad de papel hasta 550 páginas',
                        'Doble Faz automático',
    ...
    
    {
        ...
        description: [  'Coloque la impresión rápida, confiable y económica dentro del alcance.',
        ...
        general: {
            oz: 'Windows® 7, Windows® 8.1, Windows® 10, Windows® Server 2008, Windows® Server 2008R2, Windows® Server 2012, Windows® Server 2012R2, Windows® Server 2016 , Macintosh OS X v10.10 o posterior. UNIX Sun® Solaris, HP-UX, SCO OpenServer, RedHat® Linux, IBM® AIX, Citrix XenApp ',
        ...
        paperHandling: {
            paperSize:': (A4, A5, A6, B5, B6)',
            paperType: 'Papel normal, Papel reciclado, Papel especial, Papel de color, Membrete, Papel preimpreso, Sobre, Papel de etiqueta, OHP',
            paperWeight: '52 - 220 g/m²',
...

    {
        ...
        description: [  'Abraza el poder en un espacio más pequeño.',
        ...
        general: {
            oz: 'Windows® 7, Windows® 8.1, Windows® 10, Windows® Server 2008, Windows® Server 2008/R2, Windows® Server 2012/R2, Windows® Server 2016, Windows® Server 2019 Entornos Mac OS Macintosh OS X Native v10.11 o posterior. UNIX Sun® Solaris (10), HP-UX (11.x, 11i v2, 11i v3), SCO Open Server (5.0.7, 6.0, 6.x), RedHat® Linux Enterprise (V4, V5, V6), IBM® AIX (V6.1, V7.1, V7.2) ',
            size: '42,0 x 41,0 x 34,6 cm',
            weigth: '18 kg',
        }, 
        conectivity: {
            standarConectivity: 'Ethernet 10 base-T / 100 base-TX / 1000 base-T, host USB Tipo miniB, host USB I / F, Dispositivo USB 2.0, Ranura para Tarjeta SD, etiqueta NFC, Bluetooth',
            netProtocols: 'TCP/IP (IPv4, IPv6)',
        },
        paperHandling: {
            paperSize:': (A4, A5, A6, B5, B6, Legal, Carta, HLT, Ejecutivo)',
            paperType: 'Normal, Reciclar, Especial, Color, Membrete, Preimpreso, Bond, Sobres, Etiqueta y OHP',
...

    {
        ...
        description: [  'Produzca un flujo de trabajo más inteligente y asequible',
...

    {
        ...
        description: [  'Eleve sus expectativas — y mejore su productividad. El modelo RICOH® Aficio® MP 301SPF ofrece capacidades avanzadas para agilizar el flujo de trabajo y reducir el costo total de propiedad.',
        ...
        paperHandling: {
            ...
            paperEntryCapacity: 'Bandeja de 250 hojas + Bypass de 100 hojas (recomendada). 600 hojas max.',
            paperOutCapacity: '250 hojas',
        },
        modelCode: '408534T',
...

    {
        ...
        description: [  'Un MFP A4 compacto con posibilidad de funcionalidades en A3.',
        ...
        conectivity: {
            standarConectivity: 'Ethernet (puerto de red RJ-45: 10Base-T/ 100Base-TX/1000Base-T), USB 2.0 Tipo A x 2, SD ',
            netProtocols: 'TCP/IP (IPv4, IPv6)',
        },
        paperHandling: {
...

    {
        ...
        description: [  'Haga de la productividad el ajuste perfecto.',
...

    {
        ...
        description: [  'Haga espacio para un rendimiento dinámico.',
...

    {
        ...
        description: [  'Convierte el dia a dia en una jornada fácil.',
        ...
        conectivity: {
            standarConectivity: 'Ethernet 10Base-T/100Base-TX/ 1000Base-T, USB Host Tipo A I/F (2 puertos en la parte posterior del dispositivo)',
            netProtocols: 'TCP/IP (IPv4, IPv6), IPX, SPX',
        },
        paperHandling: {
...

    {
        ...
        description: [  'Amplíe su negocio con la comodidad diseñada a su medida.',
                        'Producción de hasta 25 ppm, impresión, copia, escaneo, envío de fax',
                        'Resolución de impresión máx. 600 x 600 ppp',
                        'Capacidad de papel hasta 4.700 páginas',
                        'Doble Faz automático',
...

    {
        ...
        description: [  'Color atractivo y desempeño potente a su alcance.',
                        'Producción de hasta 31 ppm, impresión, copia, escaneo, envío de fax',
                        'Resolución de impresión máx. 1200 x 1200 ppp',
...

    {
        ...
        description: [  'Lleva un rendimiento multifunción colorido a tu escritorio.',
                        'Producción de hasta 31 ppm, impresión, copia, escaneo, envío de fax',
                        'Resolución de impresión máx. 1200 x 1200 ppp',
                        'Capacidad de papel hasta 1.350 páginas',
                        'Doble Faz automático',
