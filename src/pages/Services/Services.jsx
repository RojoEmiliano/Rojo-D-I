      ...
      <div className="flex justify-center flex-col items-center   ">
        <div className="pt-4">
          <h2 className="text-xl font-semibold">
            CONOCÉ EL MEJOR SERVICIO TÉCNICO DE MENDOZA
          </h2>
        </div>
        <div className="p-5">
        ...
        <p className="text-lg w-[80%] pb-4">
          En Rojo Digitalización e Impresión, nos enorgullece destacarnos por
          ofrecer un servicio técnico ejemplar. Nuestra dedicación a la
          excelencia y nuestro compromiso con la satisfacción del cliente son
          fundamentales en todo lo que hacemos. Creemos en la buena voluntad y
          la honestidad como pilares de nuestras relaciones comerciales. Estamos
          aquí para ayudarte a alcanzar tus metas y crecer juntos. Te invitamos
          a explorar nuestros servicios y descubrir cómo podemos ser tu aliado
          de confianza en el mundo de la digitalización e impresión
        </p>
      </div>
      <hr className="" />
