...
const SobreNosotros = () => {
  return (
    <>
      <HelmetCommon title='ROJO D-I: Sobre Nosotros' />
        ...
        <div className='flex m-10 max-w-[100%] justify-center items-center'>
          <div className='flex justify-center mb:max-w-[80%] flex-col text-lg text-justify'>
            <p>
              ...
              distribuidores y servicio técnico oficial de renombradas marcas como Ricoh y Epson,
              así como proveedores y especialistas técnicos certificados por HP, Brother y Samsung,
              nos enorgullecemos de ofrecer servicios de primer nivel en el ámbito de la tecnología
              de oficina.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              equipo se convierte en una oportunidad para demostrar nuestro compromiso con la
              calidad y la excelencia. Desde ofrecer orientación personalizada hasta proporcionar
              soluciones técnicas rápidas y efectivas, nos esforzamos para asegurar que su
              experiencia con nosotros sea invariablemente satisfactoria.
            </p>
            <br />
            <p>
              ...
              industria y por nuestro compromiso inquebrantable con la calidad. En Rojo
              Digitalización e Impresión, estamos aquí para impulsar su éxito a través de la
